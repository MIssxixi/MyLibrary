...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/MIssxixi/Mylibrary'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'MIssxixi' => 'zouyongjie@haixue.com' }
  s.source           = { :git => 'https://github.com/MIssxixi/Mylibrary.git', :tag => s.version.to_s }
